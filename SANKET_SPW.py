...
class Hospital:
  def __init__(self,root):
    ...
    lbltitle=Label(self.root, bd=20, relief=RIDGE, text = "HOSPITAL MANAGEMENT SYSTEM", fg="red", bg="yellow", font=("times new roman", 50, "bold"))
...
# Buttonframe
    ...
    # DataframeLeft
    lblDoctorName = Label(DataFrameLeft, text="Name of Doctor", font=("arial", 20, "bold"),fg="violetred", padx=2, pady=6)
    ...
    lblName = Label(DataFrameLeft, font=("arial", 20, "bold"),fg="violetred", text="Name of Patient", padx=2)
    lblName.grid(row=1,column=0,sticky=W)
    txtName = Entry(DataFrameLeft, font=("arial", 20, "bold"), width=35)
    txtName.grid(row=1,column=1)

    lblBloodGroup = Label(DataFrameLeft, text="Blood Group", font=("arial", 20, "bold"),fg="violetred", padx=2, pady=6)
    ...
    lblAge = Label(DataFrameLeft, font=("arial", 20, "bold"), text="Age of Patient",fg="violetred", padx=2,pady=4)
    ...
    lblSex = Label(DataFrameLeft, text="Sex of Patient", font=("arial", 20, "bold"),fg="violetred", padx=2, pady=6)
    ...
    lblDisease = Label(DataFrameLeft, font=("arial", 20, "bold"), text="Disease",fg="violetred", padx=2,pady=6)
    ...
    #Buttons
    btnPrescription=Button(ButtonFrame,text="Prescription",bg="cyan",fg="white",font=("arial",12,"bold"),width=25,height=16,pady=6)
    ...
    btnUpdate = Button(ButtonFrame,text="Update", bg="cyan", fg="white", font=("arial", 12, "bold"), width=25, height=16,pady=6)
    btnUpdate.grid(row=0,column=2)

    btnDelete = Button(ButtonFrame,text="Delete", bg="pink", fg="white", font=("arial", 12, "bold"), width=25, height=16,pady=6)
    btnDelete.grid(row=0,column=3)

    btnClear = Button(ButtonFrame,text="Clear", bg="cyan", fg="white", font=("arial", 12, "bold"), width=25, height=16,pady=6)
